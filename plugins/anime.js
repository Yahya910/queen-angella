...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'anime', fromMe: true, desc: 'صورة انمي عشوائية'}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '*يحيى*'})

    }));
}
else if (Config.WORKTYPE == 'public') {

    Asena.addCommand({pattern: 'anime', fromMe: false, desc:'صورة انمي عشوائية '}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '*عمك يحيى*'})
